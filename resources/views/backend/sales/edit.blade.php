                ...
                <div class='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
                    ...
                    <table class="table item-table table-bordered table-hover">
                        <div class="m-2 col-4 row d-flex">
                            ...
                            <input  type="text"  id="1" placeholder="{{translate('search here....') }}"  class="form-control col-6 form-control-sm search title1"  autocomplete="off" >
                        ...
                        <tbody>
                            ...
                            <tr id="{{ $key + 1 }}">
                                ...
                                <td>
                                    ...
                                    <input  type="hidden" id="item_1"   name="items[{{$orderDetail->product_id}}][detail_id]" value="{{$orderDetail->id}}" class=" form-control form-control-sm search itemid item_id1" placeholder="@lang('site.item')" autocomplete="off">
                                    <input  type="hidden" id="item_1"   name="items[{{$orderDetail->product_id}}][id]" value="{{$orderDetail->product_id}}" class=" form-control form-control-sm search itemid item_id1" placeholder="@lang('site.item')" autocomplete="off">
                                    <span id="itemid{{$orderDetail->product_id}}">{{ $orderDetail->product->getTranslation('name') }}</span>
                                                ...
                                                <div class="aiz-radio-inline">
                                                    @foreach (json_decode($orderDetail->product->colors) as $key => $color)
                                                        ...
                                                        <label class="aiz-megabox pl-0 mr-2" data-toggle="tooltip"
                                                            ...
                                                            <input type="radio" name="items[{{$orderDetail->product_id}}][color]"
                                                                value="{{ $color_name }}"
                                ...
                                <td><input type="number" name="items[{{$orderDetail->product_id}}][price]" readonly value="{{$orderDetail->product->unit_price}}" id="price_{{$orderDetail->product_id}}" class="form-control changesNo" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;"></td>
                                <td><input type="number" name="items[{{$orderDetail->product_id}}][quantity]" value="{{$orderDetail->quantity}}" id="quantity_{{$orderDetail->product_id}}" class="form-control changesNo" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;"></td>
                                <td><input type="number" name="items[{{$orderDetail->product_id}}][total]" readonly id="total_{{$orderDetail->product_id}}" value="{{$orderDetail->price}}" class="form-control totalLinePrice" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;"></td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
                ...
                <table class="table">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="hidden" class="form-control" id="tax" value="{{$order->orderDetails->sum('tax')}}" >
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="hidden" class="form-control" id="shipping_cost" value="{{$order->orderDetails->sum('shipping_cost')}}" >
                        ...
                        <tr>
                            ...
                            <td class="text-muted h5">
                                <input  class="grand_total" type="hidden" name="grand_total" value="{{ $order->grand_total }}">
