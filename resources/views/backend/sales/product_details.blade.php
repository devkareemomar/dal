<tr>
    ...
    <td><input type="number" name="items[{{$product->id}}][price]" readonly value="{{$product->unit_price}}" id="price_{{$product->id}}" class="form-control changesNo" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;"></td>
    <td><input type="number" name="items[{{$product->id}}][quantity]" value="1" id="quantity_{{$product->id}}" class="form-control changesNo" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;"></td>
    <td><input type="number" name="items[{{$product->id}}][total]" readonly id="total_{{$product->id}}" value="{{$product->unit_price}}" class="form-control totalLinePrice" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;"></td>
</tr>
