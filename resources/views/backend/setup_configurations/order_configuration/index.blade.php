...
<div class="row">
    ...
    <div class="col-lg-6">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0 h6">{{translate('Set Order Shipment Alert')}}</h5>
            </div>
            @php
            ...
            <form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
              <div class="card-body">
                   ...
                   <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <label class="aiz-switch aiz-switch-success mb-0">
                                <input type="hidden" name="types[]" value="order_shipment_statment_status">
                                <input value="1" name="order_shipment_statment_status" type="checkbox" @if ($ship_status->value == 1)
                                    checked
                                @endif>
                                <span class="slider round"></span>
                            </label>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-12">
                            <input type="hidden" name="types[]" value="order_shipment_statment_set">
                            <input type="text" class="form-control" name="order_shipment_statment_set" value="{{ $ship_set->value }}" placeholder="{{ translate('Statment For Shipment') }}" required>
                        </div>
                    </div>
                    <div class="form-group mb-0 text-right">
                        <button type="submit" class="btn btn-sm btn-primary">{{translate('Save')}}</button>
