            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0 h6 ">{{ translate('Tap') }}</h5>
                    </div>
                    <div class="card-body">
                        <form class="form-horizontal" action="{{ route('payment_method.update') }}" method="POST">
                            ...
                            <div class="form-group row">
                                <input type="hidden" name="types[]" value="TAP_PUBLIC_KEY">
                                <div class="col-md-4">
                                    <label class="col-from-label">{{ translate('Tap Public Key') }}</label>
                                </div>
                                <div class="col-md-8">
                                    <input type="text" class="form-control" name="TAP_PUBLIC_KEY"
                                        value="pk_test_AygM9tQ6UBXNkRYu857GfKxq"
                                        placeholder="{{ translate('Tap Public Key') }}" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-md-4">
                                    <label class="col-from-label">{{ translate('Tab Active') }}</label>
                                </div>
                                <div class="col-md-8">
                                    <label class="aiz-switch aiz-switch-success mb-0">
                                        <input value="1" name="tap_payment" type="checkbox"
                                            @if (get_setting('tap_payment') == 1) checked @endif>
