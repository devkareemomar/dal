                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <input type="number" lang="en" class="form-control" name="min_qty"
                                        value="{{($product->min_qty <= 1)?$product->min_qty:$product->min_qty}}"
                                        min="1" required>
                                </div>
                            </div>
                            <div class="form-group row">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <input type="text" placeholder="{{ translate('Purchase price') }}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" required placeholder="{{ translate('SKU') }}"
                ...
                <form id="ColorForm">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" placeholder="{{ translate('Color Code') }}" id="code"
                                name="code" class="form-control" value="{{ old('code') }}" required>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary"
                            data-dismiss="modal">{{ translate('close') }}</button>
                        <button type="submit" id="addColor" class="btn btn-primary">{{ translate('Save') }}</button>
                    </div>
                </form>
        ...
        $(document).on('click', '#addColor', function(e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#colors').append(`<option  value="` + formData.get('code') +
                        `" data-content="<span><span class='size-15px d-inline-block mr-2 rounded border' style='background:` +
                        formData.get('code') + `'></span><span>` + formData.get('name') +
                        `</span></span>"></option>`);
