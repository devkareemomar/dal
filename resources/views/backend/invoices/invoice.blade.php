	...
	<div>
		...
		<div style="padding: 1rem;padding-bottom: 0">
            <table>
                ...
                <tr><td class="gry-color small">{{ translate('State') }}: {{ $shipping_address->state ?? ''}}</td></tr>
				<tr><td class="gry-color small">{{ translate('City') }}: {{ $shipping_address->city ?? ''}}</td></tr>
				<tr><td class="gry-color small">{{ translate('Block') }}: {{ $shipping_address->block ?? '' }}</td></tr>
				<tr><td class="gry-color small">{{ translate('Avenue') }}: {{ $shipping_address->avenue ?? ''}}</td></tr>
				<tr><td class="gry-color small">{{ translate('Street') }}: {{ $shipping_address->street ?? '' }}</td></tr>
				<tr><td class="gry-color small">{{ translate('House') }}: {{ $shipping_address->house  ?? ''}}</td></tr>
				<tr><td class="gry-color small">{{ translate('Floor') }}: {{ $shipping_address->floor ?? ''}}</td></tr>
                <tr><td class="gry-color small">{{ translate('Flat') }}: {{ $shipping_address->flat ?? '' }}</td></tr>
