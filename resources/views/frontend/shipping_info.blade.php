                    ...
                    @else
                        <div class="shadow-sm bg-white p-4 rounded mb-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group has-feedback">
                                        <label class="control-label">{{ translate('block')}}</label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group has-feedback">
                                        <label class="control-label">{{ translate('house')}}</label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group has-feedback">
                                        ...
                                        <input type="text" class="form-control" placeholder="{{ translate('avenue')}}" name="avenue" required>
                                    </div>
                                </div>
                            </div>
