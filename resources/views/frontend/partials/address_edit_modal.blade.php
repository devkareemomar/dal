    ...
    <div class="p-3">
        ...
        <div class="row">
         ...
         <div class="row">
            ...
            <div class="col-md-10">
                <input type="text" class="form-control mb-3" placeholder="{{ translate('avenue')}}" value="{{ $address_data->avenue }}" name="avenue"  >
            </div>
        </div>
        <div class="row">
            <div class="col-md-2">
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <input type="text" class="form-control mb-3" placeholder="{{ translate('floor')}}" value="{{ $address_data->floor }}" name="floor"  >
            </div>
        </div>
        <div class="row">
            <div class="col-md-2">
            ...
            <div class="col-md-10">
                <input type="text" class="form-control mb-3" placeholder="{{ translate('flat')}}" value="{{ $address_data->flat }}" name="flat"  >
            </div>
        </div>
