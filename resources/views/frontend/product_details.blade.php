                            ...
                            <div class="col order-1 order-md-2">
                                <div class="aiz-carousel product-gallery" data-nav-for='.product-gallery-thumb'
                                    ...
                                    <div class="">
                                            ...
                                            <!--<a href="{{ uploaded_asset($photo) }}" target="blank">-->
                                            <!--    <i class="la la-search-plus  la-2x mb-3"></i>-->
                                            <!--</a>-->

                                        <div class="carousel-box img-zoom rounded mt-2">
                                    ...
                                    @endforeach
                                    @foreach ($detailedProduct->stocks->unique('image') as $key => $stock)
                                        @if ($stock->image != null)
