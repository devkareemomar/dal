                                ...
                                <div class="row">
                                    <div class="col-xxl-8 col-xl-10 mx-auto">
                                        <div class="row gutters-10">
                                          @if (get_setting('tap_payment') == 1)
                                            <div class="col-6 col-md-4">
                                                <label class="aiz-megabox d-block mb-3">
                                                    <input value="tap" class="online_payment" type="radio"
                                                        name="payment_option" checked>
                                                    <span class="d-block aiz-megabox-elem p-3">
                                                        <img src="{{ static_asset('assets/img/cards/Tap_Payments.svg.png') }}"
                                                            class="img-fluid mb-2">
                                                        <span class="d-block text-center">
                                                            <span class="d-block fw-600 fs-15">{{ translate('Tap') }}</span>
                                                        </span>
                                                    </span>
                                                </label>
                                                <div id="tapBox"></div>
                    ...
                    if (offline_payment_active == 'true' && $('.offline_payment_option').is(":checked") && $('#trx_id').val() == '') {
                        ...
                        if($('input[name=payment_option]:checked').val() == "tap"){
                           let tapPayUrl = "{{ route("tap.pay") }}";
                            //let tapPayUrl = "http://localhost/dal-master/tap/handelPayment";
