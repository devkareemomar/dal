...
})(window,document,'script','dataLayer','GTM-WDNLVSD');</script>
<!-- End Google Tag Manager -->
    ...
    <meta name="facebook-domain-verification" content="c3h0zcarltevy219y7oano5kop3l4u" />
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-WDNLVSD"
            ...
            if($('#option-choice-form input[name=quantity]').val() > 0 && checkAddToCartValidity()){
                $.ajax({
                   ...
                   success: function(data){
                        ...
                        $('.product-gallery-thumb .carousel-box').each(function (i) {
                            if($(this).attr('image_id') && data.image_id == $(this).attr('image_id')){
                                $('.product-gallery-thumb').slick('slickGoTo', i);
                            }
                        })
