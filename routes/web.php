...
Route::controller(AddressController::class)->group(function () {
    ...
    Route::get('/addresses/customer-addresses/{customer_id}', 'getAddresses')->name('addresses.customer-addresses');
});
...
//Tap
Route::controller(TapController::class)->group(function () {
    Route::get('/tap/callBack', 'callBack')->name('tap.callBack');
    Route::post('/tap/handelPayment', 'pay')->name("tap.pay");
    Route::post('/tap/webHook', 'webhook')->name("tap.webHook");
});
//payhere below
