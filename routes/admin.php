...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function() {
    ...
    Route::controller(ProductController::class)->group(function () {
        ...
        Route::post('/products/best_selling', 'updateBestSelling')->name('products.best_selling');
    ...
    Route::controller(OrderController::class)->group(function () {
        ...
        Route::post('/bulk-order-status/{status?}', 'bulk_order_status')->name('bulk-order-status');
        Route::post('/bulk-payment-status/{status?}', 'bulk_order_payment')->name('bulk-payment-status');
        ...
        Route::post('/orders/store-order-from-admin', 'storeOrderFromAdmin')->name('orders.store-order-from-admin');
        Route::post('/orders/add-customer', 'addCustomer')->name('orders.add-customer');
    ...
    Route::controller(ReportController::class)->group(function () {
        ...
        Route::get('/profits', 'profits')->name('profits.index');
