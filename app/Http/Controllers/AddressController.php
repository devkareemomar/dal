...
class AddressController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        flash(translate('Address info added successfully'))->success();

        if($request->admin_order) return redirect('admin/orders/create?customer_id='.$request->customer_id);
...
//        return ;
    ...
    public function getAddresses($customer_id)
    {
        ...
        return view('backend.sales.addresses_customer' ,compact('addresses'));
    }
}
