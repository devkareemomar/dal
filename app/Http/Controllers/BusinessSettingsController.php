...
class BusinessSettingsController extends Controller
{
    ...
    public function payment_method_update(Request $request)
    {
        ...
        $paymentActivation = BusinessSetting::where('type', $request->payment_method . '_payment')->first();
        ...
        if ($business_settings != null) {
            ...
            if ($request->has($request->payment_method . '_payment')) {
                $paymentActivation->value = 1;
                $paymentActivation->save();
            } else {
                $paymentActivation->value = 0;
                $paymentActivation->save();
            }
        }
