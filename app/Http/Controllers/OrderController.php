...
class OrderController extends Controller
{
    ...
    public function update(Request $request, $order_id)
    {
            ...
            if (isset($request->items)) {
                    $orderDetails = collect($request->items)->mapWithKeys(function ($item) use ($order_id) {
   ...
   public function update_tracking_code(Request $request) {
    ...
    public function search($order_id,$value,$id){
        $products =  Product::where('name', 'LIKE', '%'.$value.'%')->get();
        // dd($value);
     return view('backend.sales.search', compact('products','id'));
    }// end of search


    public function additem($order_id,$id){
